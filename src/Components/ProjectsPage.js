  ...
  const projects = [
    {
      ...
      features: [
        "Authentication for users and admins (login/signup)",
        "Admin management of cities and cars (add/update/remove)",
        "Browse and rent available cars with date range selection",
        "View rental history",
        "Safe booking with pessimistic & Redis distributed locking",
        "Deadlock and race-condition free booking system",
        "Microservices architecture with service registry & API Gateway",
        "Dockerized setup with auto-build bash scripts",
      ],
    },
    {
      id: 2,
      title: "Stock Breakout Tracker",
      description:
      ...
      features: [
        ...
        "Admin dashboard to post, edit, and modify chart data",
        "User-side tracking with progress updates and history",
        "Todo tracker for users to manage watchlist and goals",
        "View, update, and modify progress in interactive UI",
        "Offline caching using Room Database",
        "Push notifications with FCM for latest stock alerts",
        "Smooth image loading and chart display with RecyclerView & Glide",
      ],
    },
    {
      id: 3,
      ...
      youtube: "https://youtube.com/shorts/h7UiXomA-bs?feature=share",
    ...
    },
    {
      ...
      note: "Currently unavailable on Play Store as the application does not support the latest Android devices. It will be updated and brought back online soon.",
      image: cppImg,
      youtube: "https://youtube.com/shorts/i1HRjuC9qvM?feature=share",
      // playstoreURL:
